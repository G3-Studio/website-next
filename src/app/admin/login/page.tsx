        ...
        <div className="flex flex-col w-full font-sans lg:w-1/2">
          <div className="flex justify-center pt-12 lg:justify-start lg:pl-12 lg:-mb-24">
            <Link href="/" className="p-4 text-xl font-bold">
              <svg version="1.1" viewBox="0 0 270.93 270.93" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="w-16 h-16 logo">
                <defs>
          ...
          <div className="flex flex-col justify-center px-8 pt-8 my-auto lg:justify-start lg:pt-0 lg:px-24 xl:px-32">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col pt-3 lg:pt-8">
              <div className="flex flex-col pt-4">
                ...
                <input type="email" name="email" id="email" placeholder="your@email.com" className="w-full px-3 py-3 mt-1 leading-tight text-gray-700 transition-all duration-100 border-2 rounded-lg appearance-none focus: focus:border-official-orange focus:outline-none" required />
              </div>
              <div className="flex flex-col pt-4">
                <label htmlFor="password" className="text-lg font-semibold">
                  Password
                </label>
                <input type="password" name="password" id="password" placeholder="Password" className="w-full px-3 py-3 mt-1 leading-tight text-gray-700 transition-all duration-100 border-2 rounded-lg appearance-none focus: focus:border-official-orange focus:outline-none" required />
              </div>
              ...
              <input type="submit" defaultValue="Log In" className="p-2 mt-4 text-lg font-bold text-white transition-all duration-200 rounded-lg cursor-pointer bg-gradient-to-r from-official-yellow to-official-red hover:grayscale" />
            </form>
          </div>
        </div>
        {/* Image Section */}
